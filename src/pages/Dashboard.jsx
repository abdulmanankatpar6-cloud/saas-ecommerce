...
const Dashboard = () => {
  ...
  const { recommendedProducts, recentlyViewed, personalizedOffers, continueShoppingItems } = usePersonalization();
  ...
  const stats = [
    { icon: DollarSign, label: 'Total Revenue', value: '$45,231', change: '+12.5%', color: '#4F46E5' },
      ...
      <div className="dashboard">
        ...
        <div className="hero-section">
          <div className="hero-content">
            <h1>Power Up Your Business<br />with Our E-Commerce Solutions!</h1>
            <p>Drive the success of your online business with powerful analytics and seamless order management. Get started today!</p>
        ...
        <div className="personalized-section offers-section">
          <div className="section-header">
            <h2><Tag size={20} /> Special Offers</h2>
          </div>
        ...
        {recentlyViewed.length > 0 && (
          <div className="personalized-section recently-viewed-section">
            <div className="section-header">
              <h2><Clock size={20} /> Recently Viewed</h2>
            </div>
            <div className="products-grid">
        ...
        {continueShoppingItems.length > 0 && (
          <div className="personalized-section continue-shopping-section">
            <div className="section-header">
              <h2><ShoppingBag size={20} /> Continue Shopping</h2>
            </div>
            <div className="products-grid">
