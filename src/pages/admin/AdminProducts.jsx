      ...
      <div className="admin-products">
        ...
        <div className="products-toolbar">
          ...
          <div className="toolbar-stats">
            ...
            <span>
              In Stock: <strong>{products.filter(p => p.stock > 0).length}</strong>
            </span>
            {storageUsage > 0 && (
        ...
        <div className="products-grid">
          {filteredProducts.map(product => (
            <div key={product.id} className="product-card-admin">
              <img src={product.image} alt={product.name} width="280" height="200" loading="lazy" />
                ...
                {formData.images.length === 0 && (
                  <div className="form-group">
                    ...
                    <small className="form-hint">
                      Provide an image URL if you don't upload images
                    </small>
                  </div>
                )}
                ...
                {isStorageNearCapacity() && (
                  <div className="storage-warning-box">
                    ...
                    <div>
                      ...
                      <p>
                        You're using {storageUsage}% of available storage. Consider deleting old
                        products or reducing image sizes.
                      </p>
                    </div>
                  </div>
                )}
