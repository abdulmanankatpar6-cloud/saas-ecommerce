...
export const MessageProvider = ({ children }) => {
    ...
    return saved ? JSON.parse(saved) : [
      {
        ...
        message: 'Welcome to NextWeb! We\'re excited to have you here. Check out our latest products and exclusive offers.',
        time: '2 hours ago',
      ...
      },
      {
        ...
        message: 'Great news! Your order #1234 has been shipped and is on its way to you. Expected delivery: 2-3 business days.',
        time: '5 hours ago',
      ...
      },
      {
        ...
        message: 'This weekend only! Get 20% off on all electronics. Use code: WEEKEND20 at checkout.',
        time: '1 day ago',
      ...
      },
      {
        ...
        message: 'We just added amazing new products to our store. Be the first to check them out!',
        time: '3 days ago',
  ...
  const addMessage = (messageData) => {
    const newMessage = {
      ...
      avatar: messageData.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(messageData.from || 'System')}&background=4F46E5&color=fff`,
